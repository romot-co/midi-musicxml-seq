      ...
      <ModalBody>
        <Row>
          <Col lg="10" className="mx-auto text-sm">
            <h2 className="h6 fw-bold">{t('helpModal.about')}</h2>
            <ul>
              <li>{t('helpModal.about1')}</li>
              <li>{t('helpModal.about2')}</li>
              <li>{t('helpModal.about3')}</li>
            </ul>
            <h2 className="h6 fw-bold">{t('helpModal.note')}</h2>
            <ul>
              <li>{t('helpModal.note1')}</li>
              <li>{t('helpModal.note2')}</li>
            </ul>
            <h2 className="h6 fw-bold">{t('helpModal.misc')}</h2>
            <ul>
              <li>
            ...
            <h2 className="h6 fw-bold">MusicXML</h2>
            <ul>
